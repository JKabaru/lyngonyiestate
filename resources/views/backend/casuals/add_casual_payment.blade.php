                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endforeach
                            ...
                            <form method="POST" action="{{ route('store.casual.payment')}}" class="forms_sample">
                                @csrf
                                {{-- the id is hidden --}}
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="payment_status" id="payment_status" value="pending">
                                                <label class="form-check-label" for="payment_status">
                                                    Pending
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="payment_status" id="payment_status2" value="payed">
